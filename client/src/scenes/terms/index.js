  ...
  return (
    <>
      ...
      <div className="privacy-policy">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to TranslateIt.io.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to TranslateIt.io, accessible from{" "}
              <a
                href="https://www.translateit.io"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.translateit.io
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: info@translateit.io</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://www.translateit.io/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.translateit.io/contact
              </a>
            </p>
          </li>
        </ul>
